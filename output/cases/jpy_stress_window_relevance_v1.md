# JPY Stress Window Relevance v1
...
- Top event-alignment chain: `USD -> CHF -> JPY -> USD`
- Top alignment chain RMSD rank: `5`
- Alignment score: `0.061291257800`
- Relevance alignment score: `0.061291257800`
- Impact alignment score: `1.103242640400`
...
The official event is represented by ANAS as a monetary_policy, macro_growth, inflation, trade_policy exposure with currency pressure around JPY, USD, CHF, EUR. In the 7_day window, FrictionGraph's largest standalone RMSD chain is EUR -> SGD -> JPY -> EUR, while the strongest event-overlap chain is USD -> CHF -> JPY -> USD. These are different chains, which helps separate broad market stress from event-specific currency-chain alignment.
...
- `output/alignment_jpy_stress_relevance/waterfall_category_daily.csv`
- `output/alignment_jpy_stress_relevance/waterfall_currency_daily.csv`
...
- Alignment score: `0.061123975020`
...
## 3. Foreign Exchange Intervention Operations (October 30, 2025 through November 26, 2025)
...
- Alignment score: `0.039058563000`
...
## 4. FY2025 JGB Issuance Plan, Revised in November Supplementary Budget
...
- Top alignment chain RMSD rank: `2`
- Alignment score: `0.006975569640`
...
- Top RMSD chain: `EUR -> SGD -> CHF -> EUR`
- Top event-alignment chain: `USD -> SGD -> JPY -> USD`
- Top alignment chain RMSD rank: `19`
- Alignment score: `0.006127854800`
- Relevance alignment score: `0.006127854800`
- Impact alignment score: `0.000000000000`
...
The official event is represented by ANAS as a monetary_policy, macro_growth, commodities_metals exposure with currency pressure around JPY, USD, XAU. In the 7_day window, FrictionGraph's largest standalone RMSD chain is EUR -> SGD -> CHF -> EUR, while the strongest event-overlap chain is USD -> SGD -> JPY -> USD. These are different chains, which helps separate broad market stress from event-specific currency-chain alignment.
